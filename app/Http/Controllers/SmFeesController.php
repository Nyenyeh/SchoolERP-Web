            ...
            if(isset($request->send_email)){
                ...
                foreach($request->student_list as $student){
                    ...
                    if($student_detail->email != ""){
                       ...
                       send_mail($student_detail->email, $student_detail->full_name, 'Due Payment' , 'backEnd.feesCollection.dues_fees_email', $compact);
                    ...
                    if($parent_detail->guardians_email != ""){
                       send_mail($parent_detail->guardians_email, $parent_detail->guardians_name, 'Due Payment' , 'backEnd.feesCollection.dues_fees_email', $compact);
