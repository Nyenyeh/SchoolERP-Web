            ...
            try {
                ...
                try {
                    if (count($user_info) != 0) {
                        ...
                        $compact['data'] =  array('email' => $request->email, 'id' => $staff->id,'username' => $user->username,'slug' =>'staff' );
                        
                        send_mail($request->email, $staff->full_name,'Login Credentials',"backEnd.studentInformation.user_credential" ,$compact);
