...
class SmExaminationController extends Controller
{
   ...
   if ($is_duplicate) {
    ...
    public function examAttendanceSearch(Request $request)
    {
      ...
      try{
            $exam_schedules = SmExamSchedule::where('class_id', $request->class)
    ...
    public function meritListReportSearch(Request $request)
    {
        ...
        if ($request->method() == 'POST') {
            ...
            if ($optional_subject_setup=='') {
                ...
                return view('backEnd.reports.merit_list_report', compact('iid', 'exams', 'classes', 'subjects', 'class', 'section', 'exam', 'subjectlist', 'allresult_data', 'class_name', 'assign_subjects', 'exam_name', 'InputClassId', 'InputExamId', 'InputSectionId','optional_subject_setup','failgpaname'));
            }
         }
        }catch (\Exception $e) {
    ...
    public function meritListPrint($exam_id, $class_id, $section_id)
    {
       ...
       return view('backEnd.reports.merit_list_report_print',compact('exams','classes','subjects','class','section','exam','subjectlist','allresult_data','class_name','assign_subjects','exam_name','optional_subject_setup','subject_total_mark'));
