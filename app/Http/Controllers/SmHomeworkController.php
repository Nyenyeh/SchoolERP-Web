...
class SmHomeworkController extends Controller
{
        ...
        try {
            ...
            foreach ($students as $student) {
                ...
                try{
                    ...
                    Notification::send($user, new HomeworkNotification($homeworks));
                }catch (\Exception $e) {
                ...
                $parent = SmParent::find($student->parent_id);
                        ...
                        $notidication->message = app('translator')->get('lang.homework_assigned_child');
    ...
    public function searchEvaluation(Request $request)
    {
        ...
        try {
            if (teacherAccess()) {
                $homeworkLists = SmHomework::where('active_status', '=', '1')
