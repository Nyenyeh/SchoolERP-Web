...
//     Route::get('contact', 'SmFrontendController@contact');
      ...
      Route::redirect('course', 'login');
      Route::redirect('course-Details/{id}', 'login');
      Route::redirect('news-page', 'login');
      Route::redirect('news-details/{id}', 'login');
