...
Route::group(['middleware' => ['XSS','subscriptionAccessUrl']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
        ...
        // delete fees payment
        Route::post('fees-payment-delete', 'SmFeesController@feesPaymentDelete')->name('fees-payment-delete')->middleware('userRolePermission:1002');
        Route::get('edit-fees-payment/{id}',['as' => 'edit-fees-payment', 'uses' => 'SmFeesController@editFeesPayment'])->middleware('userRolePermission:1001');
        Route::post('fees-payment-update',['as' =>'fees-payment-update','uses' => 'SmFeesController@updateFeesPayment'])->middleware('userRolePermission:1001');
        ...
        Route::get('fee-voucher-print', ['as' => 'monthly-collection-report', 'uses' => 'BulkPrintController@feeVoucherPrint'])->middleware('userRolePermission:840');
        Route::post('monthly-collection-search', ['as' => 'monthly-collection-search', 'uses' => 'SmFeesController@monthlyCollectionReportReportSearch']);
        Route::get('monthly-collection-search', ['as' => 'monthly-collection-search', 'uses' => 'SmFeesController@monthlyCollectionReportReport']);
