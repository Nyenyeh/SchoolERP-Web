...
<head>
    ...
    <title>@lang('lang.password') @lang('lang.reset') </title>
            ...
            <div class="col-lg-5 col-md-8">
                <div class="form-wrap text-center">
                    ...
                    <div class="text-center">
                        <h5 class="text-uppercase font-bold">@lang('lang.password') @lang('lang.reset')</h5>
                    ...
                    <form method="POST" class="" action="{{ route('email/verify') }}">
                        ...
                        <div class="form-group input-group mb-4 mx-3">
                            ...
                            <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" type="email"
                                   name='email' placeholder=" @lang('lang.enter') @lang('lang.your') @lang('lang.email') "/>
                            @if ($errors->has('email'))
