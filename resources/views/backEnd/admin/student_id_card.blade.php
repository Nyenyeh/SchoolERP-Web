            ...
            <div class="col-lg-4">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @else
                         @if(userPermission(46))
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'student-id-card',
                                ...
                                <div class="row no-gutters input-right-icon mt-25">
                                    ...
                                    <div class="col-auto">
                                        <button class="primary-btn-small-input" type="button">
                                            ...
                                            <input type="file" class="d-none" name="logo" id="document_file_3" value="{{isset($id_card)? ($id_card->file != ""? getFilePath3($id_card->logo):''): ''}}">
                                        </button>
                                    </div>
                                </div>
                                <div class="row mt-25">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="{{route('student-id-card-edit',$id_card->id)}}">@lang('lang.edit')</a>
                                                @endif
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    ...
                                                    {{ Form::open(['route' => array('student-id-card-delete',$id_card->id), 'method' => 'DELETE', 'enctype' => 'multipart/form-data']) }}
