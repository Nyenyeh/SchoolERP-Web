   ...
   <li data-position="{{menuPosition(76)}}" class="sortable_li">
       ...
       <ul class="collapse list-unstyled" id="subMenuParentExamination">
           @foreach($childrens as $children)
               ...
               @endif
               @if(userPermission(79) && menuStatus(79))
                   <li  data-position="{{menuPosition(79)}}">
                       <a href="{{ route('parent_online_examination', [$children->id])}}">@lang('lang.online_exam')</a>
                   </li>
                   <li >
                       <a href="{{ route('parent_online_examination_result', [$children->id])}}">@lang('lang.online_exam') @lang('lang.result')</a>
                   </li>
               @endif
               <hr>
           @endforeach
                ...
                @lang('lang.bbb')
                            ...
                            <ul class="collapse list-unstyled" id="bigBlueButtonMenu">
                                ...
                                <li data-position="{{menuPosition(115)}}" >
                                    <a href="{{ route('parent.bbb.class.recording.list') }}"> @lang('lang.class') @lang('lang.record') @lang('lang.list')</a>
                                </li>
                                @endif
                            
                                @if(userPermission(116) && menuStatus(116))
                                    <li data-position="{{menuPosition(116)}}" >
                                        <a href="{{ route('parent.bbb.meeting.recording.list') }}"> @lang('lang.meeting') @lang('lang.record') @lang('lang.list')</a>
                                    </li>
                                @endif
