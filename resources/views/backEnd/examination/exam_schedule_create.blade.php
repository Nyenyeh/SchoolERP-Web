                        ...
                        <tr>
                            ...
                            @foreach($exam_periods as $exam_period)
                                @php
                                    ...
                                    $section_id=$assign_subject->section_id;
                            ...
                            <td>
                                @if(@$assigned_routine == "")
                                    @if(@$assigned_routine_subject == "")
                                        ...
                                        <div class="col-lg-6">
                                            <a href="{{route('add-exam-routine-modal', [$assign_subject->subject_id, $exam_period->id, $class_id, $section_id, $exam_id])}}" class="primary-btn small tr-bg icon-only mr-10 modalLink" data-modal-size="modal-md" title="@lang('lang.create') @lang('lang.exam_routine')">
                                ...
                                @else
                                    <div class="col-lg-6">
                                        ...
                                        <a href="{{route('edit-exam-routine-modal', [$assign_subject->subject_id, $exam_period->id, $class_id, $section_id, $exam_id, $assigned_routine->id])}}" class="modalLink" data-modal-size="modal-md" title="@lang('lang.edit') @lang('lang.exam_routine')">
                                            <span class="ti-pencil-alt" id="addClassRoutine"></span>
                                        </a>
                                        <a href="{{route('delete-exam-routine-modal', [$assigned_routine->id])}}" class="modalLink" data-modal-size="modal-md" title="@lang('lang.delete') @lang('lang.exam_routine')">
