                                        ...
                                        <div class="card-body">
                                            ...
                                            <table class="w-100 mt-30 mb-20 table table-bordered">
                                                <thead>
                                                    <tr class="text-center">
                                                        ...
                                                        @foreach($assinged_exam_types as $assinged_exam_type)
                                                            ...
                                                            @endphp
                                                        <th colspan="4" class="text-center">{{$exam_type->title}}</th>
                                                        @endforeach
                                                ...
                                                <tbody>
                                                    ...
                                                    @endphp
                                                    <tr class="text-center">
                                                        <th class="text-center">@lang('lang.result')</th>
                                                        @php
                                                            $term_base_gpa  = 0;
                                                            $average_gpa  = 0;
                                                        ...
                                                        @endphp
                                                        <th colspan="4" class="text-center"> @lang('lang.average') @lang('lang.gpa') : 
