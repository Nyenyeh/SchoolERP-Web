    ...
    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'fees-payment-update',
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <input type="hidden" id="payment_mode" value="{{$fees_payment->payment_mode}}">
                 ...
                 <div class="row mt-50" id="feesBankPayment">
                    ...
                    <div class="col-lg-9">
                        <div class="input-effect">
                            ...
                            <option value="{{$value->id}}" {{$fees_payment->bank_id ==$value->id ? 'selected' : ''}}> {{$value->bank_name}}</option>
                            @endforeach
                            @endif
                            </select>
                            <span class="focus-border"></span>
