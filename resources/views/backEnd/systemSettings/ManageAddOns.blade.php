                                ...
                                @foreach($modules as $module)
                                        ...
                                        @if($module->is_default==0)
                                            ...
                                            <td>
                                                ...
                                                @endif
                                                <small class="text-success text-bold"> ( Version: {{$module->version}}</small> )
                                                <p>{{$module->notes}}</p>

                                                @if(!empty($module->purchase_code)) 
                                                    <p class="text-success">
                                                        Verified | Publishedon 
                                                    {{date("F jS, Y", strtotime($module->activated_date))}}</p> 
                                                @elseif(file_exists($is_module_available))
                                                    <p class="text-success"> Purchased </p> 
                                                @else
                                                    <p class="text-danger"> Not Purchased </p>
                                                @endif
                                            </td>
                                            <td>
                                                @if( moduleStatusCheck($module->name) == False) 
                                                    <a class="primary-btn small {{$module->name}} bg-warning text-white border-0"href="#"> 
                                                        @lang('lang.disable') 
                                                    </a>
                                                @elseif(moduleStatusCheck($module->name) == True)
                                                    <a class="primary-btn small {{$module->name}} bg-success text-white border-0" href="#"> 
                                                        @lang('lang.active') 
                                                    </a>
                                                @else
                                                    <a class="primary-btn small {{$module->name}} bg-success text-white border-0" href="#"> 
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                   ...
                                                   <div class="form-group">
                                                        ...
                                                        <input type="email" class="form-control" name="envatouser"
                                                               required="required"
